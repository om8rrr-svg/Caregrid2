...
function handleHashNavigation() {
    // Skip auto-scrolling on dashboard page
...
function updateNavbarAuthState() {
    ...
    // First try to use authSystem if available
    if (window.authSystem && window.authSystem.isAuthenticated()) {
        isAuthenticated = true;
        currentUser = window.authSystem.getCurrentUser();
    } else {
        // Fallback: check localStorage/sessionStorage directly
        try {
            const storedUser = JSON.parse(localStorage.getItem('careGridCurrentUser') || sessionStorage.getItem('careGridCurrentUser') || 'null');
            const storedToken = localStorage.getItem('careGridToken') || sessionStorage.getItem('careGridToken');
